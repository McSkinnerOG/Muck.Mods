...
namespace MOD
{
    ...
    public class Main : BaseUnityPlugin
    {
        ...
        public void InitConfig()
        {
            ...
            MODULES.STATS.STAMINA.StaminaDrain = Config.Bind("Cheats", "Stamina Drain", 999f, new ConfigDescription("Stamina Drain Amount Over Time", new AcceptableValueRange<float>(0f, 1000f)));
            ...
            MODULES.STATS.HUNGER.HungerDrain = Config.Bind("Cheats", "Hunger Drain", 999f, new ConfigDescription("Hunger Drain Amount Over Time", new AcceptableValueRange<float>(0f, 1000f)));
            ...
            MODULES.STATS.SHIELD.ShieldMax = Config.Bind("Cheats", "Shield Max", 999, new ConfigDescription("Maximum Hunger Value", new AcceptableValueRange<int>(1, 9999999))); 
            ...
            //GOD
            MODULES.STATS.GOD.HP = Config.Bind("Cheats", "HP", 100, new ConfigDescription("Player HP", new AcceptableValueRange<int>(1, 100000)));
